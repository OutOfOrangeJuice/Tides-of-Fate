...
- Will: For not staying down
- Sleaze: For sneaky smarts
- Aptitude: For learning stuff
- Moxie: For sick one-liners

Draw stats by playing blackjack
- Shuffle the deck
- Pick 2 starting cards
- Ace can be either 1 or 11
- Face cards are 10
- Can draw or stand, ideally want to get to 21
- If you go over 21, discard your bust card and stop drawing to tally up total (including bonus cards)
